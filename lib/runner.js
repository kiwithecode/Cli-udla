...
// Ejecuta Claude Code en modo no-interactivo (-p) con el prompt (y el MCP de Playwright si aplica).
function runAgent(key, target) {
  ...
  // --allowedTools es variádico: consume todo lo que le siga sin guion. Lo cerramos
  // con el flag booleano -p para que el prompt NO sea engullido como nombre de herramienta.
