...
const COMMANDS = {
  ...
  // showOutput: imprime en consola el resumen final del agente (tabla de casos
  // con ✅/❌), además de dejarlo en el informe.
  servicio: {
    prompt: 'qa-servicio', tipo: 'servicio', playwright: false, casos: false, showOutput: true,
