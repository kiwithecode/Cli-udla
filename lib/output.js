...
// Paso 1 de la planificación según el tipo de comando (web vs API vs móvil).
function planExploreStep(cfg) {
  ...
  if (cfg.tipo === 'movil') {
    return 'Lanzá la app en el emulador/simulador (con Maestro) y recorré las pantallas principales ' +
      'para entender los flujos (login, navegación, formularios). No corras el set completo todavía.';
  }
